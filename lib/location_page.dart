...
import 'package:jadwalku/home_page.dart';
  ...
  getAddress({String? city}) async {
    ...
    try {
      if (city == null) {
        ...
        var res = await Dio()
            .get('https://api.myquran.com/v1/sholat/kota/cari/$city');
        _listAddress = res.data['data'] as List<dynamic>;
      }
...
class Praytime {
  Praytime({this.jadwal, this.lokasi});
